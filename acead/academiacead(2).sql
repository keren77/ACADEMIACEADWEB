...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 08, 2018 at 09:16 AM
...
(7, 'IRMA', 'REGISTRO', 'PRUEBA', 'LO', '89898989', 'kul@gh.hn', '801000000000', '', NULL, '0000-00-00', NULL, NULL, 1, 2),
(8, 'IRMA', 'REGISTRO', 'PRUEBA', 'LO', '89898989', 'kul@gh.hn', '801000000000', '', NULL, '0000-00-00', NULL, NULL, 1, 2),
(9, 'IRMA', 'REGISTRO', 'PRUEBA', 'LO', '89898989', 'kul@gh.hn', '801000000000', '', NULL, '0000-00-00', NULL, NULL, 1, 2),
(10, 'IRMA', 'REGISTRO', 'ALONZO', 'LO', '89898989', 'kul@gh.hn', '801000000000', '', NULL, '0000-00-00', NULL, NULL, 1, 2);
...
(1, 'Administrador', 'Administrador del Si', 'SysAdmin', NULL, '2018-10-17', NULL),
(2, 'Docente', 'Docente de la Academ', 'SysAdmin', NULL, '2018-11-08', NULL);
...
INSERT INTO `tbl_usuarios` (`Id_usuario`, `Usuario`, `Contrasena`, `FechaUltimaConex`, `PreguntasContestadas`, `PrimerIngreso`, `FechaVencimiento`, `CorreoElectronico`, `Id_Estado`, `Id_Rol`, `Id_Empleado`, `FechaCreacion`, `FechaModificacion`, `CreadoPor`, `ModificadoPor`) VALUES
(1, 'admin', 'administrator1', '2018-11-07 06:10:59', 1, 1, '2020-12-31', 'admin@admin.com', 3, 1, 1, '2018-10-22', '2018-10-22', 'adminsis', 'adminsis'),
(2, 'prueba', 'prueba123456', '2018-11-07 07:25:57', 3, NULL, '2018-11-30', 'prueba@prueba.com', 1, 1, 3, '2018-11-07', NULL, '1', NULL),
(27, 'IRMAALONZO', '', '2018-11-08 05:03:19', 3, NULL, '0000-00-00', 'kul@gh.hn', 1, 1, 9, '0000-00-00', NULL, 'AUTOREGISTRO', NULL);
...
--
ALTER TABLE `tbl_estadocivil`
  MODIFY `Id_estadocivil` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

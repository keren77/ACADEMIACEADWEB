...
<html lang="en">
  ...
  <body class="text-center">
    ...
    <form action="php/validar.php" method="post">
      ...
      <?php if($error==1){ ?>
      <label style="color: red;">Usuario y/o contraseña incorrecta</label>
      <?php } ?>
      <?php if($error==2){ ?>
      <label style="color: red;">Su usuario esta bloqueado o inactivo, favor comuniquese con el administrador</label>
      <?php } ?>
      <?php if($r){ ?>
      <label style="color: red;">Ha sobrepasado los intentos permitidos</label>
      <?php } ?>
      ...
      <button type="button" class="btn btn-link"><a href="autoregistro.php">REGISTRATE</a></button>

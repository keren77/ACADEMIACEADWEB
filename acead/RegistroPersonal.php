             ...
             <!-- formulario de registro de Alumnos -->
              ...
              <!--  <button type="button" onclick="formu(0)" class="btn btn-primary btn-block" >Siguiente</button>-->
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-6">
                    <button  type="reset" name="botonautoregistro"onclick="formu(4)" class="btn btn-primary btn-block" >Registrar</button>
                    </div>
                  </div>
...
if (isset($_POST['cbosexo'])){
  ...
  if (isset($_POST['cboestadocivil'])){
      $auto_estcivil = $_POST['cboestadocivil'];
    } else {
        echo 'aqui se dio el error';
    }
...
$contr_encrypt = password_hash($auto_pass,1);
...
VALUES('$auto_prim_nombre', '$auto_seg_nombre','$auto_prim_apellido', '$auto_seg_apellido', '$auto_telefono', '$auto_cedula', '$auto_email', 'AUTOREGISTRO', '1', '$auto_estcivil', '$auto_sexo' ) ";
...
VALUES('$auto_usuario', '$contr_encrypt', '3', '$auto_email', '1', '1', '$cal', 'AUTOREGISTRO')";

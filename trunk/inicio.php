...
<head>
    ...
    <link rel="stylesheet" href="cead/assets/css/normalize.css">
    <link rel="stylesheet" href="cead/assets/css/bootstrap.min.css">
    <link rel="stylesheet" href="cead/assets/css/font-awesome.min.css">
    <link rel="stylesheet" href="cead/assets/css/themify-icons.css">
    <link rel="stylesheet" href="cead/assets/css/flag-icon.min.css">
    <link rel="stylesheet" href="cead/assets/css/cs-skin-elastic.css">
    <!-- <link rel="stylesheet" href="assets/css/bootstrap-select.less"> -->
    <link rel="stylesheet" href="cead/assets/scss/style.css">
    <link href="cead/assets/css/lib/vector-map/jqvmap.min.css" rel="stylesheet">
...
<body>
    ...
    <aside id="left-panel" class="left-panel">
        <nav class="navbar navbar-expand-sm navbar-default">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="./"><img src="images/logo_inicio.jpg" alt="Logo"></a>
                <a class="navbar-brand hidden" href="./"><img src="images/logo_mini.jpg" alt="Logo"></a>
            </div>
                ...
                <ul class="nav navbar-nav">
                   ...
                   <li class="menu-item-has-children dropdown">
					...
					<li class="menu-item-has-children dropdown">
                     ...
                     <li class="active">
                        <a href="login.php?logout"> <i class="menu-icon fa fa-close"></i>Salir del Sistema</a>
                    </li>
                    ...
                    <div class="header-left">
                        ...
                        <div class="dropdown for-message">
                          ...
                          <div class="dropdown-menu" aria-labelledby="message">
                            ...
                            <a class="dropdown-item media bg-flat-color-1" href="#">
                                <span class="photo media-left"><img alt="avatar" src="portrait/images/avatar/1.jpg"></span>
                            ...
                            <a class="dropdown-item media bg-flat-color-4" href="#">
                                <span class="photo media-left"><img alt="avatar" src="portrait/images/avatar/2.jpg"></span>
                                <span class="message media-body">
                            ...
                            <a class="dropdown-item media bg-flat-color-3" href="#">
                                <span class="photo media-left"><img alt="avatar" src="portrait/images/avatar/4.jpg"></span>
                                <span class="message media-body">
                ...
                <div class="col-sm-5">
                    <div class="user-area dropdown float-right">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <img class="user-avatar rounded-circle" src="portrait/phone.jpg" alt="User Avatar">
                        </a>

                        <div class="user-menu dropdown-menu">
                                <a class="nav-link" href="#"><i class="fa fa- user"></i>Funcion 1 No Agregada</a>

                                <a class="nav-link" href="#"><i class="fa fa- user"></i>Funcion 2 No Agregada <span class="count">13</span></a>

                                <a class="nav-link" href="#"><i class="fa fa -cog"></i>Funcion 3 No Agregada</a>
    ...
    <script src="cead/assets/js/vendor/jquery-2.1.4.min.js"></script>
    <script src="https://cdnjs.cloudflare.com/ajax/libs/popper.js/1.12.3/umd/popper.min.js"></script>
    <script src="cead/assets/js/plugins.js"></script>
    <script src="cead/assets/js/main.js"></script>


    <script src="cead/assets/js/lib/chart-js/Chart.bundle.js"></script>
    <script src="cead/assets/js/dashboard.js"></script>
    <script src="cead/assets/js/widgets.js"></script>
    <script src="cead/assets/js/lib/vector-map/jquery.vmap.js"></script>
    <script src="cead/assets/js/lib/vector-map/jquery.vmap.min.js"></script>
    <script src="cead/assets/js/lib/vector-map/jquery.vmap.sampledata.js"></script>
    <script src="cead/assets/js/lib/vector-map/country/jquery.vmap.world.js"></script>
    <script>
        ( function ( $ ) {
            "use strict";

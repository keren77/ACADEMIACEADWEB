    ...
    <div class="card">
        ...
        <div class="card-body card-block">
            <form action="funciones.php" method="post" id="frmusuario" class>
                ...
                <div class="form-group">
                    <div class="input-group">
                        <input type="text" name="txtnombreusuario" placeholder="Nombre de Usuario a registrar" class="form-control" required="">
                        <div class="input-group-addon">
                            <i class="fa fa-address-card"></i>
                        </div>
                    </div>
                ...
                <div class="row col-md-12">
                    <label for="selectSm" class=" form-control-label">Pregunta 1: </label>
                    <div class="col-12 col-md-12">
                        <select name="cbopregunta1" id="SelectLm" class="form-control-md form-control" required="">
                            <option value="0" disabled="" selected="">Please select</option>
                ...
                <div class="form-group"><label for="street" class=" form-control-label">Respuesta</label><input type="text" name="txtres1" id="street" placeholder="Ingrese aquì su respuesta" class="form-control" required=""></div>

                <div class="row col-md-12">
                    <label for="selectSm" class=" form-control-label">Pregunta 2: </label>
                    <div class="col-12 col-md-12">
                        <select name="cbopregunta2" id="SelectLm" class="form-control-md form-control" required="">
                            <option value="0" disabled="" selected="">Please select</option>
                            <option value="1">¿Cual es el nombre de tu primer mascota?</option>
                            <option value="2">¿Cual es el nombre de tu primer Jefe?</option>
                            <option value="3">¿Cual es el nombre de tu tio favorito?</option>
                ...
                <div class="form-group"><label for="street" class=" form-control-label">Respuesta</label><input type="text" name="txtres2" id="street" placeholder="Ingrese aquì su respuesta" class="form-control" required=""></div>

                <div class="row col-md-12">
                    <label for="selectSm" class=" form-control-label">Pregunta 3: </label>
                    <div class="col-12 col-md-12">
                        <select name="cbopregunta3" id="SelectLm" class="form-control-md form-control" required="">
                            <option value="0" disabled="" selected="">Please select</option>
                            <option value="1">¿Cual es el nombre de tu primer mascota?</option>
                            <option value="2">¿Cual es el nombre de tu primer Jefe?</option>
                            <option value="3">¿Cual es el nombre de tu tio favorito?</option>
                ...
                <div class="form-group"><label for="street" class=" form-control-label">Respuesta</label><input type="text" name="txtres3" id="street" placeholder="Ingrese aquì su respuesta" class="form-control" required=""></div>

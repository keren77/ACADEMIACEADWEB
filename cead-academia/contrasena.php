                      ...
                      <div class="card-body card-block">
                        <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                          <div class="row form-group">
                            <div class="col col-md-3"><label class=" form-control-label">ID Usuario</label></div>
                          ...
                          <div class="row form-group">
                            ...
                            <div class="col-12 col-md-9"><input type="password" id="hf-password" name="hf-password" placeholder="Contraseña Anterior" class="form-control"></div>
                          </div>
						  <hr>
						  <div class="row form-group">
                            <div class="col col-md-3"><label for="hf-password" class=" form-control-label">Nueva Contraseña</label></div>
                            <div class="col-12 col-md-9"><input type="password" id="hf-password" name="hf-password" placeholder="Ingrese una contraseña..." class="form-control"></div>
                          </div>
						  <div class="row form-group">
                            <div class="col col-md-3"><label for="hf-password" class=" form-control-label">Confirmar Contraseña</label></div>

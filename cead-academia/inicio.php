            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="menu-icon fa fa-fort-awesome"></i><a href= "../cead-academia/html/empleado.php">Creacion de Personal</a></li>
                            <li><i class="menu-icon fa fa-fort-awesome"></i><a href= "../cead-academia/pantallas/nuevousuario.php">Creacion de Usuario</a></li>
                        </ul>
                    </li>
                    <li class="menu-item-has-children dropdown">
